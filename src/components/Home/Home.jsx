...
const Home = () => {
    ...
    return (
        <>
            <section className='hero-section relative mb-28'>
                <img
                    src={HeroImage}
                    alt='House'
                    className='hero-image w-full'
                />
                <div className='overlay absolute top-0 left-0 bg-black h-full w-full opacity-30 z-10'></div>
            ...
            <section className='our-services mb-28'>
            ...
            <section className='why-us mb-28'>
                <div className='container  mx-auto'>
                    <div className='why-us-container services-card-container grid lg:grid-cols-2 gap-24'>
                        ...
                        <div className='why-us-text-containe'>
                            ...
                            <div className='sub-text'>
                                ...
                                <h5 className='text-xl mb-10'>
                                    We have a huge list of houses and
                                    apartments to fit your needs.
                                </h5>
                                <h4 className='text-2xl mb-4 flex'>
            ...
            <section className='our-properties mb-28'>
                <div className='container  mx-auto'>
                    {(listings && listings.length > 0) ? (<Recommended listings={listings} />) : <></>}
                </div>
            </section>
            <section className='Offers relative mb-28'>
                <img
                    src={OfferImage}
                    alt='House'
                    className='offers-image w-full'
                />
            ...
            <section className='testimonial mb-28 '>
                <div className='container grid lg:grid-cols-3 gap-24 mx-auto'>
                    <div className='testimonial-card'>
                        <Card>
                            ...
                            <p>
                                It was a pleasure to deal with you and it
                                was comfortable for all services as I wanted
                            </p>
