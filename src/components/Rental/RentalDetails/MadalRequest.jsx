...
const ModalRequest = (props) => {
  ...
  return (
    <Modal show={props.show} size="md" popup={true} onClose={props.close}>
      <Modal.Header />
      <Modal.Body>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div>
              <div className="relative z-0 mb-10 w-full group">
                <label className="text-sm text-gray-500 ">Select a date</label>
                <input
                  type="date"
                  name="date"
            ...
            <div className="mb-4">
              <div className="mb-2 block">
                <Label htmlFor="message" value="Add a message" />
              </div>
              <TextInput id="message" type="text" sizing="md" />
            </div>
