                ...
                <div className="h-[90%] lg:overflow-auto  p-4">
                    <div id="overview" className="h-auto mb-4">
                        ...
                        <p className="mb-2 text-neutral-400">
                            3 Bedrooms+Den ; 2.5 Bathrooms, Brand New Kitchen,
                            Stainless Steel Appliances, Dishwasher, Microwave,
                            Formica Countertops, Private Garage, Corner Unit.
                        </p>
                                    ...
                                    <div className="flex ">
                                        ...
                                        <div className="w-[70%]">
                                            <p className="text-sm mb-2 neutral-400">
                                                "The rooms were clean, very
                                                comfortable, and the staff was
                                                amazing. They went over and
                                                beyond to help make our stay
                                                enjoyable. I highly recommend
                                                this hotel for anyone visiting
                                                downtown"
                                            </p>
                                            <Rating>
                                                <Rating.Star />
